...
# MAGIC To run this demo, just select the cluster `dbdemos-mlops-end2end-vishesh_arya` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/0404-004923-1s6ds7uf/configuration)). <br />
...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-science&org_id=1444828305810485&notebook=%2F00_mlops_end2end_presentation&demo_name=mlops-end2end&event=VIEW&path=%2F_dbdemos%2Fdata-science%2Fmlops-end2end%2F00_mlops_end2end_presentation&version=1">
...
# MAGIC
# MAGIC Ultimately, we will be able to build a [complete DBSQL Churn Dashboard](/sql/dashboards/661574c2-ac6a-4f9d-a216-d059a68109cf-churn-prediction-dashboard---universal?o=1444828305810485#) containing all our customer & churn information!
