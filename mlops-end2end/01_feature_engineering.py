...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-science&org_id=1444828305810485&notebook=%2F01_feature_engineering&demo_name=mlops-end2end&event=VIEW&path=%2F_dbdemos%2Fdata-science%2Fmlops-end2end%2F01_feature_engineering&version=1">
...
# MAGIC %run ./_resources/00-setup $reset_all_data=false $catalog="dbdemos_vishesh"
...
try:
  ...
  fs.drop_table(f'dbdemos_vishesh.ml.churn_features')
except:
  pass

# COMMAND ----------

# churn_features_table = fe.create_table(
#   name='dbdemos_vishesh.ml.churn_features',
