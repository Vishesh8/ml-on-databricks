...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-science&org_id=1444828305810485&notebook=%2F02_automl_baseline&demo_name=mlops-end2end&event=VIEW&path=%2F_dbdemos%2Fdata-science%2Fmlops-end2end%2F02_automl_baseline&version=1">
...
run = get_automl_churn_run(f'dbdemos_vishesh.ml.churn_features', force_refresh = False)
